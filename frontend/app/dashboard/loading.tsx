 ...
 * bundel JS selesai diunduh. Bentuknya sengaja meniru tata letak dashboard
...
export default function Loading() {
  return (
    <div style={{ minHeight: '100vh', background: BG }} aria-busy="true" aria-label="Memuat dashboard">
